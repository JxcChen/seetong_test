...
public class AddNVRDevicePage extends BasePage {
    ...
    public AddNVRDevicePage(AndroidDriver driver){
        super(driver);
    }
    ...
    public AddNVRDevicePage addDeviceThroughLan(String deviceId,String devicePassword){
        clickElement(addDeviceBtn);
        clickElement(NVR);
    ...
    public String getAddDeviceToastTips(){
        String toastTipsContent = getElementText(toastTips);
